plotprocmoncsv -sp -t "Kovter Example 1" -f ../gallery/procmoncsv/kovter1_example1.html /Source/Procmon\ CSV/Kovter1_focused.csv
plotprocmoncsv -sp -t "Kovter Example 2" -f ../gallery/procmoncsv/kovter1_example2.html /Source/Procmon\ CSV/Kovter1.csv
plotprocmoncsv -sp -pfw -pfd -pfn -t "Kovter Example 3" -f ../gallery/procmoncsv/kovter1_example3.html /Source/Procmon\ CSV/Kovter1.csv
plotprocmoncsv -sp -prw -prd -t "Kovter Example 4" -f ../gallery/procmoncsv/kovter1_example4.html /Source/Procmon\ CSV/Kovter1.csv
plotprocmoncsv -sp -pt -pu -t "Kovter Example 5" -f ../gallery/procmoncsv/kovter1_example5.html /Source/Procmon\ CSV/Kovter1.csv
plotprocmoncsv -sp -t "Kovter Example 1" -f ../gallery/procmoncsv/kovter2_example1.html /Source/Procmon\ CSV/Kovter2_focused.csv
plotprocmoncsv -sp -t "Kovter Example 2" -f ../gallery/procmoncsv/kovter2_example2.html /Source/Procmon\ CSV/Kovter2.csv
...
plotcuckoojson -t "Kovter Example 1" -f ../gallery/cuckoojson/kovter1_example1.html -fa -ra -na -gp dot /Source/cuckoo-modified-json/1_report.json
...
plotcuckoojson -t "Kovter Example 1" -f ../gallery/cuckoojson/kovter2_example1.html -fa -ra -na -gp dot /Source/cuckoo-modified-json/2_report.json
